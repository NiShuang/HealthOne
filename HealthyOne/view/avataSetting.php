...
<div class="daohang">
	<div class="menu">
    	<ul>
      		<li class="menu-item"><a href="http://localhost/healthyone/view/setting.php">基本信息</a></li>
            <li class="menu-item_cur"><a href="http://localhost/healthyone/view/avataSetting.php">头像设置</a></li>
            <li class="menu-item"><a href="http://localhost/healthyone/view/passwordSetting.php">修改密码</a></li>
        </ul>
    </div>
</div>
<div class="content">
	<form name="information" action="http://localhost/healthyOne/controller/accountProcess.php?operation=4">
		<div class = "upload">
