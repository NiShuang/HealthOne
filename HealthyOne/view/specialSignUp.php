...
<body>
	...
	<form id="slick-login" action="http://localhost/HealthyOne/controller/signUpProcess.php?type=2" method="post" onsubmit="return check()">
		<p class="tittle">注册</p>
		...
		<textarea rows="5" cols="26" name="introduction" id="introduction" placeholder="introduction"></textarea>
